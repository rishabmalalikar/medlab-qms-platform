...
app.post("/d10-hemoglobin/submit", async (req, res) => {
  try {
    ...
    await pool.request()
      .input("FormName", sql.NVarChar, "D-10 HEMOGLOBIN TESTING SYSTEM")
      .input("ActivityDate", sql.Date, d.date)
    ...
    res.send("D-10 Hemoglobin maintenance saved successfully");
...
app.get("/view-form-data/:formName/:date", async (req, res) => {
  try {
    ...
    const tableMap = {
      ...
      "D-10 HEMOGLOBIN TESTING SYSTEM": "D10_Hemoglobin_Maintenance_Log",
